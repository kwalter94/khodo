    ...
    chart.setOption({
      ...
      series: [
        ...
        },
        {
          ...
          type: "line",
          smooth: true,
          data: report.map(({savings}) => Math.fround(savings)),
      ...
      series: [
        {
          ...
          type: "line",
          smooth: true,
          data: report.map(({average_income}) => Math.fround(average_income)),
          itemStyle: { color: "rgb(0, 0, 255)" },
        },
        {
          ...
          type: "line",
          smooth: true,
          data: report.map(({average_expenses}) => Math.fround(average_expenses)),
          itemStyle: { color: "rgb(255, 0, 0)" },
        },
        {
          ...
          type: "line",
          smooth: true,
          data: report.map(({average_savings}) => Math.fround(average_savings)),
          itemStyle: { color: "rgb(0, 128, 0)" },
          areaStyle: { color: "rgba(0, 128, 0, 0.5)" },
        },
      ],
