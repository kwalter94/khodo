...
_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["default"].start();
 ...
 // Autoload chartjs
chart_js_auto__WEBPACK_IMPORTED_MODULE_2__.Chart.defaults.plugins.legend.position = "bottom";
...
Stimulus.load((0,_hotwired_stimulus_webpack_helpers__WEBPACK_IMPORTED_MODULE_4__.definitionsFromContext)(context));

/***/ }),

/***/ "./src/js/controllers/assets_charts_controller.js":
/*!********************************************************!*\
  !*** ./src/js/controllers/assets_charts_controller.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _createClass(_default, [{
    ...
    value: function () {
      ...
      function load_report() {
        return _load_report.apply(this, arguments);
      }
      return load_report;
    }()
  }, {
    key: "plotAssetsDistributionChart",
    value: function plotAssetsDistributionChart(data) {
      data = data.filter(function (_ref2) {
        var total_assets = _ref2.total_assets,
          period = _ref2.period;
        return total_assets > 1 && period == 1;
      });
      var ctx = this.element.querySelector("#assets-distribution");
      new chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart(ctx, {
        type: "pie",
        data: {
          labels: data.map(function (_ref3) {
            var account_name = _ref3.account_name;
            return account_name;
          }),
          datasets: [{
            label: "Asset Accounts",
            data: data.map(function (_ref4) {
              var total_assets = _ref4.total_assets;
              return total_assets;
            }),
            borderWidth: 1
          }]
    ...
    key: "plotAssetsGrowthChart",
    value: function plotAssetsGrowthChart(report) {
      var ctx = this.element.querySelector("#assets-growth");
      var months = new Set();
      var accounts = new Map();
      var _iterator = _createForOfIteratorHelper(report),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var _step$value = _step.value,
            month = _step$value.month,
            account_name = _step$value.account_name,
            total_assets = _step$value.total_assets;
          months.add(month);
      ...
      new chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart(ctx, {
        type: "bar",
        data: {
          labels: _toConsumableArray(months.values()),
          datasets: _toConsumableArray(accounts.entries()).map(function (_ref5) {
...
var map = {
	"./assets_charts_controller.js": "./src/js/controllers/assets_charts_controller.js"
};
